                            ...
                            <div class="row g-4">
                                <div class="col-lg-7">
                                    ...
                                    <div class="d-flex justify-content-between">
                                                ...
                                                <div class="video position-relative">
                                                    ...
                                                    <div id="light">
                                                        ...
                                                        <video id="VisaChipCardVideo" width="600" controls>
                                                            <source
                                                                    src="{{ asset('storage/app/public/advertisement') }}/{{$advertisement?->attachment?->file_name}}"
                                                                    type="video/mp4">
                                                        </video>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <a href="#" class="d-block h-200" onclick="lightbox_open();">
                                                            <video class="max-w360" width="450">
                                                                <source src="{{ asset('storage/app/public/advertisement') }}/{{$advertisement?->attachment?->file_name}}"
                                                                        type="video/mp4">
                                                            </video>
                                                        </a>
                                                    </div>
                                        ...
                                        @elseif($advertisement->type == 'profile_promotion')
                                            <div class="d-flex gap-3 flex-wrap">
                                                @foreach($advertisement->attachments as $image)
                                                    @if($image->type == 'provider_profile_image')
                                                        <div class="d-flex flex-column gap-2">
                                                            <h4 class="mb-2">{{translate('Profile Image')}}</h4>
                                                            <div class="img-wrap">
                                                                <a data-lightbox="mygallery"
                                                                   href="{{ asset('storage/app/public/advertisement') }}/{{$image?->file_name}}">
                                                                    <img class="h-120 profile_img rounded"
                                                                         src="{{ asset('storage/app/public/advertisement') }}/{{$image?->file_name}}">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @if($image->type == 'provider_cover_image')
                                                        <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="py-3 px-4">
                                        <div class="media gap-2 flex-wrap">
                                            <img width="58" height="58" class="rounded-circle border border-white"
                                                 src="{{onErrorImage(
                                                    $advertisement?->provider?->logo,
                                                    asset('storage/app/public/provider/logo').'/' .$advertisement?->provider?->logo,
