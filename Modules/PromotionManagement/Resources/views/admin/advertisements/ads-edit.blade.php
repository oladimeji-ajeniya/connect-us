                                                ...
                                                <div class="d-flex flex-column align-items-center gap-3">
                                                    ...
                                                    <div class="upload-file max-w-130px">
                                                        ...
                                                        <div class="upload-file__img">
                                                            <img
                                                                src="{{asset('storage/app/public/advertisement').'/' . $advertisement?->attachments->where('type', 'provider_profile_image')->first()?->file_name}}"
                                                ...
                                                <div id="profile-preview-box" class="profile-preview-box">
                                                    <div class="bg--secondary rounded">
                                                        <div class="main-image rounded min-h-200"
                                                             style="background: url('{{asset('storage/app/public/advertisement').'/' . $advertisement?->attachments->where('type', 'provider_cover_image')->first()?->file_name}}') center center / cover no-repeat;">
                                                        </div>
                                                        <div class="rounded white-color-bg px-3 py-4 position-relative mt-n2">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between gap-2">
                                                                <div class="profile-prev-image bg--secondary me-xl-3"
                                                                     style="background: url('{{asset('storage/app/public/advertisement').'/' . $advertisement?->attachments->where('type', 'provider_profile_image')->first()?->file_name}}') center center / cover no-repeat;">
