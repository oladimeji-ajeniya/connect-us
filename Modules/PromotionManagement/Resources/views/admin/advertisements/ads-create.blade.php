                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-floating form-floating__icon mb-30">
                                            <select class="js-select theme-input-style w-100 provider-info" name="provider_id"
                                                    required>
                                        ...
                                        <div class="form-floating form-floating__icon mb-30">
                                            <input type="text" class="form-control" id="title" name="title"
                                                   placeholder="{{ translate('Title') }}" required="" value="{{old('title')}}"
                                        ...
                                        <div class="form-floating mb-30">
                                            <textarea class="form-control resize-none" id="description" required
                                                      ...
                                                      name="description"
                                                      data-preview-text="preview-description">{{old('description')}}</textarea>
