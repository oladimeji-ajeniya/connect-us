                            ...
                            <form action="{{ route('provider.advertisements.ads-store') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-floating form-floating__icon mb-30">
                                            <input type="text" class="form-control" data-preview-text="preview-title"
                                        ...
                                        <div class="form-floating mb-30">
                                            <textarea class="form-control resize-none"
                                                      data-preview-text="preview-description" id="description"
                                                      placeholder="{{translate('description')}}" maxlength="255" required
