...
class AdvertisementsController extends Controller
{
    ...
    public function AdsList(Request $request): JsonResponse
    {
        ...
        $advertisements = $this->advertisement->with(['attachments', 'note'])
    ...
    {
        $advertisement = $this->advertisement->with(['provider', 'attachments'])->find($id);
    ...
    {
        $advertisement = $this->advertisement->with(['provider:id,company_name,company_phone,company_address,company_email,logo', 'attachments', 'attachment', 'review', 'rating', 'note'])->find($id);
