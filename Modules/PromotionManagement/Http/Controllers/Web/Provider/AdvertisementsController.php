...
class AdvertisementsController extends Controller
{
    ...
    {
        $advertisement = $this->advertisement->with(['provider', 'attachments', 'note'])->find($id);
    ...
    {
        $advertisement = $this->advertisement->with(['provider', 'attachments', 'attachment', 'review', 'rating'])->find($id);
